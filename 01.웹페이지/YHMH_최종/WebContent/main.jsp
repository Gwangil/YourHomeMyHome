...
function goDetail() {
   ...
   if (indexGu==0){
      ...
      location.href="./samples/result.jsp?textGu=" + textGu +"&indexGu=" + indexGu+"&textDong=" + textDong+"&indexDong=" + indexDong; 
...
<header id="dkHead">
		...
		<a style="color : white; font-weight:bold; font-family:Monospace; font-size:36px; margin-left:20px; margin-top:15px;">YOURHOMEMYHOME</a>
</div>
</div>
</header>
...
<td><SPAN style="FONT-SIZE: 14pt; "> <FONT face=맑은고딕>
알고 싶은 집을 찾아보세요!<br>
</FONT></SPAN>
<SPAN style="FONT-SIZE: 17pt; font-weight: bold"> <FONT face=맑은고딕>
부산시 동별 아파트 매매가 검색 >
...
<form name="form">
               <select style="width:140px; height:32px; text-align:center;"  name="selectgu" id="selectgu" onchange="itemChange(this.form)">
                      <option disabled selected>구를 선택하세요</option>
                 </select> 
                  <select style="width:140px; height:32px; text-align:center;" name="selectdong" id="selectdong" >
