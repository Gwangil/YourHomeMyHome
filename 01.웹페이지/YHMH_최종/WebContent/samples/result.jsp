        ...
        <script>
            ...
            AmCharts.ready(function () {
               ...
               /*  var textGu = document.form.selectgu.options[document.form.selectgu.selectedIndex].text;
                ...
                if (indexGu.equals("북구")&&indexDong.equals("화명동")){
 ...
 */                chart.marginTop = 10;
             ...
             // LEGEND
                ...
                legend.periodValueText = "[[value]]"; // this is displayed when mouse is not over the chart.
...
<table id="example" style="width: 100%;" align="center" class="table table-striped">
        <thead>
              <tr>
              <th>단지명</th>
              <th>면적</th>
